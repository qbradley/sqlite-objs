...
static azure_ops_t g_stubOps = {
    .page_blob_create = stub_page_blob_create,
    .page_blob_write = stub_page_blob_write,
    .page_blob_read = stub_page_blob_read,
    .page_blob_resize = stub_page_blob_resize,
    .block_blob_upload = stub_block_blob_upload,
    .block_blob_download = stub_block_blob_download,
    .blob_get_properties = stub_blob_get_properties,
    .blob_delete = stub_blob_delete,
    .blob_undelete = NULL,
    .blob_exists = stub_blob_exists,
    .lease_acquire = stub_lease_acquire,
    .lease_renew = stub_lease_renew,
    .lease_release = stub_lease_release,
    .lease_break = stub_lease_break,
    .page_blob_write_batch = NULL,
    .page_blob_read_multi = NULL,
    .append_blob_create = NULL,
    .append_blob_append = NULL,
    .append_blob_delete = NULL,
    .block_blob_upload_parallel = NULL,
